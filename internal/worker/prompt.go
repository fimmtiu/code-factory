	...
	case models.PhaseImplement:
		prompt = fmt.Sprintf(
			"You are an experienced staff software developer with a keen eye for abstraction and good code design. "+
				...
				"For all of your changes, you MUST begin by writing new specs or editing existing relevant specs to cover your changes before you start coding. "+
				"Specs that cover your planned changes MUST exist before you begin changing code.\n\n"+
